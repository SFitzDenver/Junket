...
database.ref().on('value', function(snap) {
    ...
    snap.forEach(function(snapshot) {
		...
		$.ajax({
			...
			$(".itinerary").prepend("<tr><td>" + flagImage + "</td><td>" + countryButton.prop('outerHTML') + "</td><td><img class='alertIcon' src='css/" + statusImage + "'></img></td><td>" + deleteButton.prop('outerHTML') + "</td></tr>");
		});
	});	
});
